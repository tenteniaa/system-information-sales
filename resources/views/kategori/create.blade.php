          ...
          <div class="home-tab">
            <div class="d-sm-flex align-items-center justify-content-between border-bottom">
              <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link active ps-0" id="profile-tab" data-bs-toggle="tab" href="{{ route('kategori.create') }}" role="tab" aria-selected="true">Add Kategori</a>
                </li>
              </ul>
              <div>
                <div class="btn-wrapper">
                  ...
                  <div class="container-fluid">
                      <div class="col-sm-12">
                          <br>
                          <h2><b class="row justify-content-center">Tambah Kategori</b></h2>
                          </br>
                      </div>
                  </div>
                    ...
                    <div class="col-md-8">
                      <div class="card">
                        ...
                        <form action="{{ route('kategori.store') }}" method="post">
                          ...
                          <input type="text" name="id_kategori" id="id_kategori" class="form-control"></br>
